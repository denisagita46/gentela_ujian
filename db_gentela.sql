...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2020 at 04:00 PM
...
(11, '2020_06_02_024739_create_tb_asset', 11),
(12, '2020_06_02_043813_create_type_region', 12);
...
--
-- Table structure for table `sd_so_mains`
--

CREATE TABLE `sd_so_mains` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `sd_so_mains`
--

INSERT INTO `sd_so_mains` (`id`, `parent_id`, `name`, `type`, `address`, `contact`, `coordinate`, `status_id`, `level`, `latitude`, `longitude`, `created_at`, `updated_at`) VALUES
(1, 13, 'Region sumbangsel', '1', 'jl ciputat', '', '', 10, 1, 0, 0, NULL, NULL),
(2, 13, 'Region Jabar', '2', '', '', '', 10, 2, 0, 0, NULL, NULL),
(3, 13, 'region jabotabek', '3', '', '', '', 10, 3, 0, 0, NULL, NULL),
(4, 14, 'Depo Pringsewu', '3', '', '', '', 10, 0, 0, 0, NULL, NULL),
(5, 15, 'Depo Lahat', '3', '', '', '', 10, 0, 0, 0, NULL, NULL),
(6, 16, 'Depo Bogor', '3', '', '', '', 10, 0, 0, 0, NULL, NULL);
...
CREATE TABLE `tb_assets` (
  ...
  `asset_code_temp` int(50) NOT NULL,
  `asset_description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_region` int(11) NOT NULL,
  `id_depo` int(11) NOT NULL,
  `id_jenis_asset` int(11) NOT NULL,
  `plant` int(50) NOT NULL,
  `cost_center` int(100) NOT NULL,
  `capitalized_on` int(11) NOT NULL,
  `asset_main_no_text` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `serial_number` int(11) NOT NULL,
  `room` int(11) NOT NULL,
  `license_plate_number` int(11) NOT NULL,
  `vendor` int(11) NOT NULL,
  `sd_employee_id` int(11) NOT NULL,
...
INSERT INTO `tb_assets` (`id`, `trans_date`, `asset_code_temp`, `asset_description`, `id_region`, `id_depo`, `id_jenis_asset`, `plant`, `cost_center`, `capitalized_on`, `asset_main_no_text`, `serial_number`, `room`, `license_plate_number`, `vendor`, `sd_employee_id`, `start_rent`, `created_at`, `updated_at`) VALUES
(1, '2020-06-02', 181427779, 'Modiss', 13, 14, 20, 7332, 707332114, 1232019, 'Samsung A10 Blue', 0, 123, 0, 0, 0, '0000-00-00', NULL, NULL),
(2, '2020-06-02', 2147483647, 'modis', 13, 15, 10, 7332, 649496496, 1232019, 'Samsung A105 Blue', 0, 0, 0, 0, 0, '0000-00-00', NULL, NULL),
(3, '2020-06-02', 83323582, 'Laptop Dell Latitude', 13, 16, 20, 7332, 707312312, 0, 'Laptop Dell Latitude', 0, 0, 0, 0, 0, '0000-00-00', NULL, NULL);
...
(9, 'deni', '6060690', 'denisagita76@gmail.com', NULL, '$2y$10$MQbgizYPvBAISc8ND.jCNeDYXeml0eGtp2BOiSqV6QaYNqzr.W1b.', 'nxvVBE6gYEXuxbPYXxTuMTdF6KIWHFfoDPNJHG6gG8vgjibeYALqhHONLXDO', '2020-06-01 02:12:22', NULL),
...
--
-- Indexes for table `sd_so_mains`
--
ALTER TABLE `sd_so_mains`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `type_region`
--
ALTER TABLE `type_region`
...
--
-- AUTO_INCREMENT for table `sd_so_mains`
--
ALTER TABLE `sd_so_mains`
...
--
-- AUTO_INCREMENT for table `type_region`
--
ALTER TABLE `type_region`
